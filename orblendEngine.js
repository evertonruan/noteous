function orblendEngine(context) {
  ...
  if (context == 'change') {
    //alterar elementos de acordo com orbs selecionados
    ...
    //exibir/ocultar botão de cor de orb
    if (noteousSettings.selectedOrb == 'all') {
      readOptionsOrbColor.style.cssText = 'opacity: 0'
    } else if (noteousSettings.selectedOrb == 'done') {
      readOptionsOrbColor.style.cssText = 'opacity: 0'
    } else if (
      ...
      readOptionsOrbColor.style.cssText = 'opacity: 1'
    }
