...
function welcomeToNoteous(context, subcontext) {
  ...
  if (context == 'render-welcome') {
    ...
    if (subcontext == 'first-access') {
      ...
      greetingDescription2.innerHTML = `<span class="greeting-description-intro">Cópias de notas</span>Esse novo recurso abre novas possibilidades para o noteous! Agora, você pode Criar e Compartilhar uma cópia das suas notas para Abrir em outro celular ou computador que você usa o noteous preview`
      ...
      greetingDescription1.innerHTML = `<span class="greeting-description-intro">Cópias de notas</span> <br>Esse novo recurso abre novas possibilidades para o noteous! Agora, você pode Criar e Compartilhar uma cópia das suas notas para Abrir em outro celular ou computador que você usa o noteous preview`
